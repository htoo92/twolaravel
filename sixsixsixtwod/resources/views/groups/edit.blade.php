...
<div class="container">
    ...
    <form action="/groups/update/{{$group->id}}" method="post" class="form-middle">
        @csrf
        <div class="mb-3">
            <label for="groupname" class="form-label">အမည်</label>
            <input type="text" class="form-control @error('groupname') is-invalid @enderror" id="groupname" name="groupname" value="{{$group->group_name}}">
            @error('groupname')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('groupvouchercode') is-invalid @enderror" id="groupvouchercode" name="groupvouchercode" value="{{$group->group_voucher}}">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('grouplimit') is-invalid @enderror" id="grouplimit" name="grouplimit" value="{{$group->members_limit}}" min="0">
            @error('grouplimit')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
